...
# download URLs
export PANEL_DL_URL="https://github.com/pyrohost/panel/releases/latest/download/panel.tar.gz"
...
export GITHUB_BASE_URL=${GITHUB_BASE_URL:-"https://raw.githubusercontent.com/flyzar73/pyrodactyl-installer/"}
